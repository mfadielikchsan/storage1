...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Master Status Out</h1>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title"><span id="judulmodal"></span> Master Status Out</h4>
                ...
                <form method="post" id="form_id" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="status">Status Out</label>
                            <input type="text" class="form-control" name="status" id="status" autocomplete="off" required onkeyup="this.value = this.value.toUpperCase();">
                        </div>                        
                    </div>
                    <!-- Modal footer -->
