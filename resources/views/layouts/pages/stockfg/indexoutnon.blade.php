...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Out Non Delivery Finish Good</h1>
    ...
    <div class="row">
        <div class="col-md-2">
            <a href="{{ route('stock-fg.scanoutnon') }}"><button type="button" class="btn btn-danger" style="width: 90%"> <i class="fa fa-arrow-circle-right"></i> Scan Out</button></a>
        </div>
    </div>
...
<script>
    ...
    .on('preXhr.dt', function(e, settings, data) {
        ...
        "initComplete": function() {
            $('#part, #ket, #statusout').change(function() {
