...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Master Gate</h1>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title"><span id="judulmodal"></span> Master Gate</h4>
                ...
                <form method="post" id="form_id" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="gate" id="gate" autocomplete="off" required onkeyup="this.value = this.value.toUpperCase();">
                        </div>                        
                    </div>
                    <!-- Modal footer -->
